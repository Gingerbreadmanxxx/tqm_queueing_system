Public Class f_light_vehiclevb

    Private Sub f_light_vehiclevb_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Start()
    End Sub
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        space = 150
        e.Graphics.DrawString("(L.V.)", New Font("Times New Roman", 30, FontStyle.Bold), Brushes.Black, 100, space)
        space = 205
        e.Graphics.DrawString("LIGHT VEHICLE", New Font("Times New Roman", 20, FontStyle.Regular), Brushes.Black, 55, space)
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        f_ticketing.Button2.Enabled = True
    End Sub
