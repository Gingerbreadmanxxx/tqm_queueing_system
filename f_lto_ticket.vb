...
Public Class f_lto_ticket

    Private Sub f_lto_ticket_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Start()
    End Sub
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        space = 160
        e.Graphics.DrawString(Label4.Text, New Font("Times New Roman", 30, FontStyle.Bold), Brushes.Black, 85, space)
    End Sub
